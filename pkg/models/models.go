...
type Assessment struct {
	ID         uint      `gorm:"primarykey" json:"id"`
	Ticker     string    `gorm:"not null;index;uniqueIndex:idx_assessment_ticker_source" json:"ticker"`
	Source     string    `gorm:"not null;uniqueIndex:idx_assessment_ticker_source" json:"source"` // 'grok' or 'deepseek'
